...
//! adapter, session, and codec failures below, all of which are re-exported
//! here so a caller can match a failure down to its precise cause without
//! depending on the private implementation modules.
