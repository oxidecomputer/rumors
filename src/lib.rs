...
//!
//! Every session — [`gossip`](Rumors::gossip), each session driven by
//! [`gossip_when`](Rumors::gossip_when), [`bootstrap`](Peer::bootstrap), and
//! [`retire`](Peer::retire) — resolves in one of three ways:
//!
