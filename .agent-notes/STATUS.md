...
Updated: 2026-09-09 20:12 UTC by the rumors session.
...
| p2-commit-path | in review | T170 re-scope complete at `fb945237` (the escalated attempt holds the gate across snapshot, join, and swap; the ceiling clause pinned; the census re-derived under T171; Mac test surface 1877/1877); verification runner on the box (tests, no gate, at Finch's word) and a light final read running; packet rebuilt after; merges as one |
