...
Updated: 2026-09-03 04:40 UTC by the rumors session.
...
| p2-link | in review | round 1 landed at `db616f70` (slot returned at one site; two tests; unbiased selects explained), gate clean; `db616f70` verified in full; fresh-eyes round 2 running; packet after; two stops: T164 item 1 needs `dial` to take the token too (the lane's argument on the branch), and the bound's wording |
