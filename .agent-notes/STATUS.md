...
Updated: 2026-09-03 03:54 UTC by the rumors session.
...
|---|---|---|---|---|---|---|
| before | 2 of 38 lanes | 3 | 1 | 0 | 32 | 1185 of 1204 |
...
| p2-commit-path | in review | round-2 repairs landed at `71797970` (warmed pins 78/601/325, `#[must_use]` sink, meter lock, nested-branch probe, two-actions-per-key proptest), gate clean; re-verification and a light round-3 read running; packet after; one stop (the all-skipped ceiling) |
