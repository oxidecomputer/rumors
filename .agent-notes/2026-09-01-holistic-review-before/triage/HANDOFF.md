...
## Live state of the overnight run (rewritten at every event; last 2026-09-03 04:18 UTC)
...
| p1-fuzz | worktree from `fdd47747` (stacked on p1-gate) | launching | its report | acceptance, rounds, packet; child of p1-gate (never merges first) |
| p1-survivors | worktree from `fdd47747` (stacked on p1-gate) | launching | its report | acceptance, rounds, packet; child of p1-gate |
