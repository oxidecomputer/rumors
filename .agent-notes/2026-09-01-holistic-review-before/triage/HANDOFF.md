...
2. **`p2-surface`** (code tip `8a2aa4d7`, packet head `cad0b75d`; rulings 42, 44, 46, 47, 48, 49, 98, 104, 105, 109, 110 part 1): REOPENED under ruling 119 (2026-09-04): the size measures become the label `input bytes`, the x-axis caption likewise (its stop resolved by the same ruling), the sampling prose moves to rustdoc, the datasets' recorded measures relabeled. The packet `cad0b75d` is superseded when the repair lands. Its registry step (ruling 43) is held for a second launch after `p1-suites`.
...
## Live state of the overnight run (rewritten at every event; last 2026-09-04 05:05 UTC)
