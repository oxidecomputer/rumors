...
## Live state of the overnight run (rewritten at every event; last 2026-09-03 05:22 UTC)
...
| p8-tagwalk | rebased onto `90f7dd9c` (two commits: `9f9263b2` the tag pair, `95377663` annotations; unsigned) | complete; fresh-eyes round and the coordinator's acceptance run in flight | those two | packet; then p1-fuzz rebases onto `95377663` and calibrates |
