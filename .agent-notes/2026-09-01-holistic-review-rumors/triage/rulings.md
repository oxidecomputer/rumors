...
## T164 (2026-09-04): Three night rulings: the pool keys by link, a 31-byte sweep seed, the CI count waits for the generators
...
## T165 (2026-09-04): `PeerDeparted` and a supply failure outrank only the errors a death can cause
...
## T166 (2026-09-04): A key whose every action was skipped moves nothing; the vanish packet's stops; the link contract's departure sentence
...
## T167 (2026-09-04): The routed adapter owns pooling per link; `Dial` is `dial` alone
