...
- Base: `44e2296b` (main after the codec merge; the lane rebased there
  with one conflict, in the codec decode tests, where the codec's
  fresh-eyes repair rewrote the `FailAfter` fixture this lane also
  extended: the resolution keeps the codec's after-failure mode and
  read counter as the base with this lane's failure `kind` layered on,
  `new` delegating to `failing_with` with `Other`; a merged doc
  summary was split for doclint in the last commit).
- Parent: `main`.
...
| post-rebase tip | `6ec71930` | the codec, framing, cancellation, oracle, and proxy tests under `pset-run -n 40` (box) | `125 tests run: 125 passed` |
| all | `6ec71930` | `pset-run -n 40 -- just gate` on the box (lane log `gate5-6ec71930.log`) | eight streams ok (`workspace`: `1845 tests run: 1845 passed`); `fuzz` the accepted illumos leg |
...
- materialized-27 (T26) at `src/tree/mirror/streaming/materialized/unknown/tests.rs:115` ([hunk](#hunk-8))
- remote-codec-10 (T24) at `src/tree/mirror/streaming/remote/codec/decode.rs:318` ([hunk](#hunk-14))
- remote-codec-10 (T24) at `src/tree/mirror/streaming/remote/codec/decode/tests.rs:600` ([hunk](#hunk-23))
- remote-proxy-19 (T26) at `src/tree/mirror/streaming/remote/proxy/work/progress/trace/tests.rs:70` ([hunk](#hunk-79))
- Decision 56 (T19) at `src/tree/mirror/streaming/tests.rs:420` ([hunk](#hunk-83))
- Decision 56 (T19) at `src/tree/mirror/streaming/tests.rs:540` ([hunk](#hunk-85))
- streaming-tests-11 (T26) at `src/tree/mirror/streaming/tests/capacity.rs:10` ([hunk](#hunk-86))
- streaming-tests-11 (T26) at `src/tree/mirror/streaming/tests/capacity.rs:230` ([hunk](#hunk-89))
- streaming-tests-11 (T26) at `src/tree/mirror/streaming/tests/capacity.rs:270` ([hunk](#hunk-90))
- materialized-27 (T26) at `src/tree/mirror/streaming/tests/stats.rs:250` ([hunk](#hunk-106))

### production edits

- materialized-27 (T26) at `src/tree/arb.rs:509` ([hunk](#hunk-4))
- materialized-27 (T26) at `src/tree/arb.rs:690` ([hunk](#hunk-5))
- materialized-27 (T26) at `src/tree/arb.rs:730` ([hunk](#hunk-5))
- remote-codec-8 (T24) at `src/tree/mirror/streaming/remote/codec/budget.rs:43` ([hunk](#hunk-9))
- remote-codec-8 (T24) at `src/tree/mirror/streaming/remote/codec/budget.rs:168` ([hunk](#hunk-10))
- remote-codec-8 (T24) at `src/tree/mirror/streaming/remote/codec/decode.rs:55` ([hunk](#hunk-11))
- remote-codec-8 (T24) at `src/tree/mirror/streaming/remote/codec/decode.rs:156` ([hunk](#hunk-12))
- remote-codec-8 (T24) at `src/tree/mirror/streaming/remote/codec/decode.rs:210` ([hunk](#hunk-13))
- remote-codec-8 (T24) at `src/tree/mirror/streaming/remote/codec/decode.rs:335` ([hunk](#hunk-15))
- remote-codec-8 (T24) at `src/tree/mirror/streaming/remote/codec/decode.rs:348` ([hunk](#hunk-16))
- remote-codec-8 (T24) at `src/tree/mirror/streaming/remote/codec/decode/async_io.rs:16` ([hunk](#hunk-17))
- remote-codec-8 (T24) at `src/tree/mirror/streaming/remote/codec/decode/async_io.rs:212` ([hunk](#hunk-18))
- remote-codec-8 (T24) at `src/tree/mirror/streaming/remote/codec/decode/async_io.rs:209` ([hunk](#hunk-18))
- remote-codec-8 (T24) at `src/tree/mirror/streaming/remote/codec/decode/async_io.rs:463` ([hunk](#hunk-19))
- remote-codec-8 (T24) at `src/tree/mirror/streaming/remote/codec/decode/async_io.rs:555` ([hunk](#hunk-20))
- remote-codec-8 (T24) at `src/tree/mirror/streaming/remote/codec/frame.rs:36` ([hunk](#hunk-31))
- remote-proxy-tests-24 (T22) at `src/tree/mirror/streaming/remote/proxy/start.rs:112` ([hunk](#hunk-32))
- remote-proxy-tests-24 (T22) at `src/tree/mirror/streaming/remote/proxy/start.rs:136` ([hunk](#hunk-33))
- remote-proxy-tests-24 (T22) at `src/tree/mirror/streaming/remote/proxy/start.rs:163` ([hunk](#hunk-34))
- remote-proxy-19 (T26) at `src/tree/mirror/streaming/remote/proxy/work/progress/trace.rs:60` ([hunk](#hunk-78))

### tests and prose

- materialized-27 (T26) at `.agent-notes/2026-08-21-unknown-pruning-survivor/README.md:130` ([hunk](#hunk-1))
- materialized-27 (T26) at `src/tree/mirror/streaming/materialized/unknown/tests.rs:13` ([hunk](#hunk-6))
- materialized-27 (T26) at `src/tree/mirror/streaming/materialized/unknown/tests.rs:60` ([hunk](#hunk-7))
- remote-codec-8 (T24) at `src/tree/mirror/streaming/remote/codec/decode/tests.rs:14` ([hunk](#hunk-21))
- remote-codec-10 (T24) at `src/tree/mirror/streaming/remote/codec/decode/tests.rs:582` ([hunk](#hunk-22))
- remote-codec-10 (T24) at `src/tree/mirror/streaming/remote/codec/decode/tests.rs:660` ([hunk](#hunk-24))
- remote-codec-8 (T24) at `src/tree/mirror/streaming/remote/codec/decode/tests.rs:880` ([hunk](#hunk-25))
- remote-codec-8 (T24) at `src/tree/mirror/streaming/remote/codec/decode/tests.rs:900` ([hunk](#hunk-26))
- remote-codec-8 (T24) at `src/tree/mirror/streaming/remote/codec/decode/tests.rs:918` ([hunk](#hunk-27))
- remote-codec-8 (T24) at `src/tree/mirror/streaming/remote/codec/decode/tests.rs:932` ([hunk](#hunk-28))
- remote-codec-8 (T24) at `src/tree/mirror/streaming/remote/codec/decode/tests.rs:1062` ([hunk](#hunk-29))
- remote-codec-8 (T24) at `src/tree/mirror/streaming/remote/codec/decode/tests.rs:1321` ([hunk](#hunk-30))
- remote-proxy-tests-5 (T22) at `src/tree/mirror/streaming/remote/proxy/tests.rs:3` ([hunk](#hunk-35))
- remote-proxy-tests-5 (T22) at `src/tree/mirror/streaming/remote/proxy/tests.rs:30` ([hunk](#hunk-36))
- remote-proxy-tests-24 (T22) at `src/tree/mirror/streaming/remote/proxy/tests.rs:60` ([hunk](#hunk-37))
- remote-proxy-tests-5 (T22) at `src/tree/mirror/streaming/remote/proxy/tests.rs:95` ([hunk](#hunk-38))
- remote-proxy-tests-5 (T22) at `src/tree/mirror/streaming/remote/proxy/tests.rs:121` ([hunk](#hunk-39))
- remote-proxy-tests-5 (T22) at `src/tree/mirror/streaming/remote/proxy/tests.rs:150` ([hunk](#hunk-40))
- remote-proxy-tests-5 (T22) at `src/tree/mirror/streaming/remote/proxy/tests.rs:175` ([hunk](#hunk-41))
- remote-proxy-tests-5 (T22) at `src/tree/mirror/streaming/remote/proxy/tests.rs:200` ([hunk](#hunk-42))
- remote-proxy-tests-5 (T22) at `src/tree/mirror/streaming/remote/proxy/tests.rs:230` ([hunk](#hunk-43))
- remote-proxy-tests-24 (T22) at `src/tree/mirror/streaming/remote/proxy/tests.rs:263` ([hunk](#hunk-44))
- remote-proxy-tests-24 (T22) at `src/tree/mirror/streaming/remote/proxy/tests.rs:278` ([hunk](#hunk-45))
- remote-proxy-tests-5 (T22) at `src/tree/mirror/streaming/remote/proxy/tests.rs:292` ([hunk](#hunk-46))
- remote-proxy-tests-5 (T22) at `src/tree/mirror/streaming/remote/proxy/tests.rs:321` ([hunk](#hunk-47))
- remote-proxy-19 (T26) at `src/tree/mirror/streaming/remote/proxy/tests.rs:340` ([hunk](#hunk-48))
- remote-proxy-19 (T26) at `src/tree/mirror/streaming/remote/proxy/tests.rs:370` ([hunk](#hunk-49))
- remote-proxy-tests-5 (T22) at `src/tree/mirror/streaming/remote/proxy/tests.rs:386` ([hunk](#hunk-50))
- remote-proxy-tests-24 (T22) at `src/tree/mirror/streaming/remote/proxy/tests.rs:425` ([hunk](#hunk-51))
- remote-proxy-tests-5 (T22) at `src/tree/mirror/streaming/remote/proxy/tests.rs:482` ([hunk](#hunk-52))
- remote-proxy-tests-5 (T22) at `src/tree/mirror/streaming/remote/proxy/tests.rs:525` ([hunk](#hunk-53))
- remote-proxy-19 (T26) at `src/tree/mirror/streaming/remote/proxy/tests.rs:540` ([hunk](#hunk-54))
- remote-proxy-tests-24 (T22) at `src/tree/mirror/streaming/remote/proxy/tests.rs:562` ([hunk](#hunk-55))
- remote-proxy-tests-5 (T22) at `src/tree/mirror/streaming/remote/proxy/tests/containment.rs:20` ([hunk](#hunk-56))
- remote-proxy-tests-24 (T22) at `src/tree/mirror/streaming/remote/proxy/tests/containment.rs:45` ([hunk](#hunk-57))
- remote-proxy-tests-24 (T22) at `src/tree/mirror/streaming/remote/proxy/tests/containment.rs:62` ([hunk](#hunk-58))
- remote-proxy-tests-24 (T22) at `src/tree/mirror/streaming/remote/proxy/tests/containment.rs:80` ([hunk](#hunk-59))
- remote-proxy-tests-24 (T22) at `src/tree/mirror/streaming/remote/proxy/tests/declarations.rs:40` ([hunk](#hunk-60))
- remote-proxy-tests-24 (T22) at `src/tree/mirror/streaming/remote/proxy/tests/declarations.rs:125` ([hunk](#hunk-61))
- remote-proxy-tests-24 (T22) at `src/tree/mirror/streaming/remote/proxy/tests/declarations.rs:188` ([hunk](#hunk-62))
- remote-proxy-tests-24 (T22) at `src/tree/mirror/streaming/remote/proxy/tests/declarations.rs:235` ([hunk](#hunk-63))
- remote-proxy-tests-24 (T22) at `src/tree/mirror/streaming/remote/proxy/tests/declarations.rs:291` ([hunk](#hunk-64))
- remote-proxy-tests-24 (T22) at `src/tree/mirror/streaming/remote/proxy/tests/failures.rs:20` ([hunk](#hunk-65))
- remote-proxy-tests-24 (T22) at `src/tree/mirror/streaming/remote/proxy/tests/failures.rs:135` ([hunk](#hunk-66))
- remote-proxy-tests-24 (T22) at `src/tree/mirror/streaming/remote/proxy/tests/failures.rs:348` ([hunk](#hunk-67))
- remote-proxy-tests-24 (T22) at `src/tree/mirror/streaming/remote/proxy/tests/failures.rs:375` ([hunk](#hunk-68))
- remote-proxy-tests-5 (T22) at `src/tree/mirror/streaming/remote/proxy/tests/harness.rs:20` ([hunk](#hunk-69))
- remote-proxy-tests-24 (T22) at `src/tree/mirror/streaming/remote/proxy/tests/harness.rs:60` ([hunk](#hunk-70))
- remote-proxy-tests-24 (T22) at `src/tree/mirror/streaming/remote/proxy/tests/harness.rs:555` ([hunk](#hunk-71))
- remote-proxy-tests-24 (T22) at `src/tree/mirror/streaming/remote/proxy/tests/harness.rs:585` ([hunk](#hunk-72))
- remote-proxy-tests-24 (T22) at `src/tree/mirror/streaming/remote/proxy/tests/harness.rs:655` ([hunk](#hunk-73))
- remote-proxy-tests-5 (T22) at `src/tree/mirror/streaming/remote/proxy/tests/harness.rs:700` ([hunk](#hunk-74))
- remote-proxy-tests-24 (T22) at `src/tree/mirror/streaming/remote/proxy/tests/harness.rs:740` ([hunk](#hunk-75))
- remote-proxy-tests-24 (T22) at `src/tree/mirror/streaming/remote/proxy/tests/malformed.rs:3` ([hunk](#hunk-76))
- remote-proxy-tests-24 (T22) at `src/tree/mirror/streaming/remote/proxy/tests/malformed.rs:45` ([hunk](#hunk-77))
- streaming-tests-3 (T127) at `src/tree/mirror/streaming/tests.rs:10` ([hunk](#hunk-80))
- streaming-tests-3 (T127) at `src/tree/mirror/streaming/tests.rs:80` ([hunk](#hunk-81))
- streaming-tests-3 (T127) at `src/tree/mirror/streaming/tests.rs:200` ([hunk](#hunk-81))
- streaming-tests-3 (T127) at `src/tree/mirror/streaming/tests.rs:250` ([hunk](#hunk-81))
- streaming-tests-3 (T127) at `src/tree/mirror/streaming/tests.rs:300` ([hunk](#hunk-82))
- Decision 56 (T19) at `src/tree/mirror/streaming/tests.rs:340` ([hunk](#hunk-83))
- Decision 56 (T19) at `src/tree/mirror/streaming/tests.rs:360` ([hunk](#hunk-83))
- Decision 56 (T19) at `src/tree/mirror/streaming/tests.rs:390` ([hunk](#hunk-83))
- Decision 56 (T19) at `src/tree/mirror/streaming/tests.rs:392` ([hunk](#hunk-83))
- streaming-tests-3 (T127) at `src/tree/mirror/streaming/tests.rs:515` ([hunk](#hunk-84))
- streaming-tests-11 (T26) at `src/tree/mirror/streaming/tests/capacity.rs:30` ([hunk](#hunk-86))
- streaming-tests-11 (T26) at `src/tree/mirror/streaming/tests/capacity.rs:60` ([hunk](#hunk-86))
- streaming-tests-11 (T26) at `src/tree/mirror/streaming/tests/capacity.rs:158` ([hunk](#hunk-87))
- streaming-tests-11 (T26) at `src/tree/mirror/streaming/tests/capacity.rs:216` ([hunk](#hunk-88))
- streaming-tests-11 (T26) at `src/tree/mirror/streaming/tests/capacity.rs:316` ([hunk](#hunk-91))
- streaming-tests-11 (T26) at `src/tree/mirror/streaming/tests/capacity.rs:326` ([hunk](#hunk-92))
- streaming-tests-11 (T26) at `src/tree/mirror/streaming/tests/capacity.rs:360` ([hunk](#hunk-93))
- streaming-tests-11 (T26) at `src/tree/mirror/streaming/tests/capacity.rs:375` ([hunk](#hunk-94))
- streaming-tests-3 (T127) at `src/tree/mirror/streaming/tests/faults.rs:6` ([hunk](#hunk-95))
- streaming-tests-3 (T127) at `src/tree/mirror/streaming/tests/faults.rs:20` ([hunk](#hunk-96))
- streaming-tests-3 (T127) at `src/tree/mirror/streaming/tests/faults.rs:77` ([hunk](#hunk-97))
- streaming-tests-3 (T127) at `src/tree/mirror/streaming/tests/faults.rs:93` ([hunk](#hunk-98))
- streaming-tests-3 (T127) at `src/tree/mirror/streaming/tests/faults.rs:104` ([hunk](#hunk-99))
- streaming-tests-3 (T127) at `src/tree/mirror/streaming/tests/faults.rs:145` ([hunk](#hunk-100))
- streaming-tests-3 (T127) at `src/tree/mirror/streaming/tests/faults.rs:219` ([hunk](#hunk-101))
- streaming-tests-3 (T127) at `src/tree/mirror/streaming/tests/faults.rs:271` ([hunk](#hunk-102))
- streaming-tests-3 (T127) at `src/tree/mirror/streaming/tests/faults.rs:284` ([hunk](#hunk-103))
- streaming-tests-3 (T127) at `src/tree/mirror/streaming/tests/stats.rs:22` ([hunk](#hunk-104))
- streaming-tests-3 (T127) at `src/tree/mirror/streaming/tests/stats.rs:40` ([hunk](#hunk-105))
- materialized-27 (T26) at `src/tree/mirror/streaming/tests/stats.rs:210` ([hunk](#hunk-106))
...
<a id="hunk-2"></a>
### .agent-notes/2026-09-01-holistic-review-rumors/triage/annotations/p1-harness-crate.tsv `@@ -0,0 +1,118 @@`
...
+src/tree/mirror/streaming/remote/codec/decode/async_io.rs	555	remote-codec-8	T24	The local classify is deleted (annotated at the line after it).
...
+src/tree/mirror/streaming/remote/codec/decode/tests.rs	1321	remote-codec-8	T24	The corner loop's bound is the named constant.
+
...
+src/tree/mirror/streaming/remote/codec/decode/tests.rs	900	remote-codec-8	T24	Fresh-eyes repair (round 1, item 2): FailAfter carries the kind its failing read reports; failing_with is the constructor, new keeps Other. Rebase onto main: layered on the codec repair's AfterFailure mode and read counter, both kept.
+src/tree/mirror/streaming/remote/codec/decode/tests.rs	932	remote-codec-8	T24	Fresh-eyes repair: the failing read reports the fixture's kind.
+src/tree/mirror/streaming/remote/codec/decode/tests.rs	1062	remote-codec-8	T24	Fresh-eyes repair: names and tests the classification the classify routing changed, an UnexpectedEof-kind transport failure inside a supply body and inside a listing entry is Truncated at the interrupted part in both decoders (it was Read on the async side); the commit message says so.
...
+src/tree/mirror/streaming/remote/codec/decode/tests.rs	880	remote-codec-8	T24	Fresh-eyes repair, round 2: FailAfter's doc names the kind it carries and which constructor sets it; after the rebase onto main it also says the codec repair's `after` mode decides what follows the failure.
...
+src/tree/mirror/streaming/remote/codec/decode/tests.rs	918	remote-codec-8	T24	Rebase onto main: failing_with initializes the kind beside the codec repair's read counter; both fields kept.
```

*(review record; no annotation expected)*

<a id="hunk-3"></a>
### .agent-notes/2026-09-01-holistic-review-rumors/triage/reviews/p1-harness-crate.md `@@ -0,0 +1,4498 @@`
...
<a id="hunk-18"></a>
### src/tree/mirror/streaming/remote/codec/decode/async_io.rs `@@ -206,16 +206,15 @@ struct Arrived {`

```diff
@@ -206,16 +206,15 @@ struct Arrived {
 }
...
<a id="hunk-19"></a>
### src/tree/mirror/streaming/remote/codec/decode/async_io.rs `@@ -463,11 +462,8 @@ impl<'a, R: AsyncRead + Unpin> AsyncFrameDecoder<'a, R> {`

```diff
@@ -463,11 +462,8 @@ impl<'a, R: AsyncRead + Unpin> AsyncFrameDecoder<'a, R> {
             // short to hold a record's heads cannot be a lone record and
             // is rejected on the declared length alone.
             let budget = self.budget;
-            let overbatched = move || DecodeErrorKind::OverbatchedRun {
...
<a id="hunk-20"></a>
### src/tree/mirror/streaming/remote/codec/decode/async_io.rs `@@ -558,15 +554,3 @@ fn partial_head(input: &mut &[u8]) -> Result<Option<cbor::Head>, DecodeErrorKind`

```diff
@@ -558,15 +554,3 @@ fn partial_head(input: &mut &[u8]) -> Result<Option<cbor::Head>, DecodeErrorKind
         ))),
     }
 }
-
...
<a id="hunk-25"></a>
### src/tree/mirror/streaming/remote/codec/decode/tests.rs `@@ -809,8 +876,11 @@ enum AfterFailure {`

```diff
@@ -809,8 +876,11 @@ enum AfterFailure {
 }
...
<!-- annotation -->
> **remote-codec-8** (T24), line 880:
>
> Fresh-eyes repair, round 2: FailAfter's doc names the kind it carries and which constructor sets it; after the rebase onto main it also says the codec repair's `after` mode decides what follows the failure.

<a id="hunk-26"></a>
### src/tree/mirror/streaming/remote/codec/decode/tests.rs `@@ -822,10 +892,22 @@ struct FailAfter {`

```diff
@@ -822,10 +892,22 @@ struct FailAfter {
     after: AfterFailure,
     failed: bool,
...
<!-- annotation -->
> **remote-codec-8** (T24), line 900:
>
> Fresh-eyes repair (round 1, item 2): FailAfter carries the kind its failing read reports; failing_with is the constructor, new keeps Other. Rebase onto main: layered on the codec repair's AfterFailure mode and read counter, both kept.

<a id="hunk-27"></a>
### src/tree/mirror/streaming/remote/codec/decode/tests.rs `@@ -833,6 +915,7 @@ impl FailAfter {`

```diff
@@ -833,6 +915,7 @@ impl FailAfter {
             after,
             failed: false,
...
<!-- annotation -->
> **remote-codec-8** (T24), line 918:
>
> Rebase onto main: failing_with initializes the kind beside the codec repair's read counter; both fields kept.

<a id="hunk-28"></a>
### src/tree/mirror/streaming/remote/codec/decode/tests.rs `@@ -847,7 +930,7 @@ impl FailAfter {`

```diff
@@ -847,7 +930,7 @@ impl FailAfter {
             }
...
<!-- annotation -->
> **remote-codec-8** (T24), line 932:
>
> Fresh-eyes repair: the failing read reports the fixture's kind.

<a id="hunk-29"></a>
### src/tree/mirror/streaming/remote/codec/decode/tests.rs `@@ -973,6 +1056,60 @@ fn opener_read_failures_are_reported_in_wire_order() {`

```diff
@@ -973,6 +1056,60 @@ fn opener_read_failures_are_reported_in_wire_order() {
     }
 }
...
<!-- annotation -->
> **remote-codec-8** (T24), line 1062:
>
> Fresh-eyes repair: names and tests the classification the classify routing changed, an UnexpectedEof-kind transport failure inside a supply body and inside a listing entry is Truncated at the interrupted part in both decoders (it was Read on the async side); the commit message says so.

<a id="hunk-30"></a>
### src/tree/mirror/streaming/remote/codec/decode/tests.rs `@@ -1182,7 +1319,7 @@ fn overbatched_corners_classify_exactly() {`

```diff
@@ -1182,7 +1319,7 @@ fn overbatched_corners_classify_exactly() {
     let zero = RunBudget::from_bytes(0);
     for speaker in SPEAKERS {
         // Declared bodies too short for a record's heads, none delivered.
-        for declared in 0..RECORD_TAG_LEN + 1 {
