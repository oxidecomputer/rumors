...
- [x] State and test when a checkpoint makes older bookmark state reclaimable — `84b211b6`.
      Sources: `session-bookmark-21`, T32.

- [x] Keep bookmark recovery behind durable writes and disjoint from pending bootstrap forks — `84b211b6`.
      Source: regression found while investigating bookmark retention, 2026-09-14.
