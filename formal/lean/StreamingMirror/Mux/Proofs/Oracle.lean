...
the keystone and chase consume them; its preservation along `MReachable`
is the MUX-ADJUDICATION §4 stage-F obligation (`muxInv_init` is landed
as the base case). Discharging it closes `oracle_deadlock_free`
unconditionally.
-/
