...
pub struct OpSpec {
    ...
    /// The variant label distinguishing this panel where one doc site
    /// carries several ("floor + ceiling", "vs `Version`"); empty for a
    /// site's only panel. Leads the island summary so stacked charts
    /// scan by variant.
