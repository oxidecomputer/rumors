...
mod query_superlinearity_pins {
    ...
    /// 18,210 -> 68,413 across pure_comb(1,000, 1,000) ->
    /// pure_comb(2,000, 2,000), packed 626B -> 1,251B: per-byte growth
    /// x1.88 (still rising at the next doubling: x1.91); the floor
