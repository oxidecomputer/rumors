...
/// conversion-class cells (distinct from the *hugeleaf display pair* of
/// board rows, `version_display` and `clock_display`, rostered red above
/// at the general ceiling — four cell IDs end in `/hugeleaf`, two sets).
///
