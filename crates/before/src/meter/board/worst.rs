...
pub(super) const WORST_RANKINGS: &[(&str, &str, [&str; 4])] = &[
    ...
    ("default", "causally_contains", ["hugeleaf", "ascend-plateau", "dense-suffix", "ascend-plateau"]),
    ("default", "span_place", ["hugeleaf", "staircase", "staircase", "staircase"]),
    ("default", "span_dominance", ["hugeleaf", "staircase", "staircase", "staircase"]),
    ("default", "query_contains", ["hugeleaf", "staircase", "staircase", "staircase"]),
    ("default", "query_coverage", ["hugeleaf", "staircase", "staircase", "staircase"]),
    ...
    ("acceptance", "causally_contains", ["hugeleaf", "ascend-plateau", "dense-suffix", "ascend-plateau"]),
    ...
    ("acceptance", "query_contains", ["hugeleaf", "staircase", "freeze-pos", "staircase"]),
    ("acceptance", "query_coverage", ["hugeleaf", "staircase", "freeze-pos", "staircase"]),
