...
pub(super) const WORST_RANKINGS: &[(&str, &str, [&str; 3])] = &[
    ...
    ("default", "version_tick", ["ascend-cliff", "memo-oscillating", "mirror-narrow"]),
    ("default", "version_ticks", ["ascend-cliff", "memo-oscillating", "reveal-hifloor"]),
    ...
    ("default", "clock_tick", ["ascend-cliff", "memo-oscillating", "mirror-narrow"]),
    ...
    ("acceptance", "version_tick", ["ascend-cliff", "memo-oscillating", "mirror-narrow"]),
    ("acceptance", "version_ticks", ["ascend-cliff", "memo-oscillating", "reveal-hifloor"]),
    ...
    ("acceptance", "query_coverage", ["hugeleaf", "memo-oscillating", "staircase"]),
    ...
    ("acceptance", "clock_tick", ["ascend-cliff", "memo-oscillating", "mirror-narrow"]),
