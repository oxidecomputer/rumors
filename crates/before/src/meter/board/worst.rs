...
pub(super) const WORST_RANKINGS: &[(&str, &str, [&str; 4])] = &[
    ("default", "version_decode", ["hugeleaf", "freeze-pos", "staircase", "staircase"]),
    ("default", "version_encode", ["promo-rearm", "-", "-", "-"]),
    ("default", "version_cmp", ["hugeleaf", "freeze-pos", "staircase", "staircase"]),
    ("default", "version_eq", ["-", "-", "-", "-"]),
    ("default", "version_concurrent", ["hugeleaf", "freeze-pos", "staircase", "staircase"]),
    ("default", "version_join", ["hugeleaf", "jump-pair", "mirror-wide", "staircase"]),
    ("default", "version_join_assign", ["hugeleaf", "jump-pair", "mirror-wide", "staircase"]),
    ("default", "version_meet", ["hugeleaf", "jump-pair", "weight-comb", "staircase"]),
    ("default", "version_meet_assign", ["hugeleaf", "jump-pair", "weight-comb", "staircase"]),
    ("default", "version_span", ["jump-pair", "jump-pair", "jump-pair", "concurrent-pair"]),
    ("default", "span_encode", ["promo-rearm", "-", "-", "-"]),
    ("default", "span_decode", ["hugeleaf", "freeze-pos", "weight-comb", "staircase"]),
    ("default", "version_tick", ["ascend-cliff", "hugeleaf", "hugeleaf", "mirror-narrow"]),
    ("default", "version_ticks", ["ascend-cliff", "bigroot", "reveal-comb", "mirror-narrow"]),
    ("default", "version_tick_adv_party", ["id-pair", "comb-scatter", "id-pair", "-"]),
    ("default", "version_rank", ["wide-arming", "wide-arming", "staircase", "harmonic"]),
    ...
    ("default", "version_distance", ["wide-arming", "wide-arming", "staircase", "harmonic"]),
    ("default", "version_lag", ["wide-arming", "wide-arming", "staircase", "harmonic"]),
    ("default", "ranked_cmp", ["wide-arming", "dense-suffix", "staircase", "harmonic"]),
    ("default", "ranked_encode", ["wide-arming", "wide-arming", "staircase", "harmonic"]),
    ("default", "ranked_encode_rank", ["wide-arming", "wide-arming", "staircase", "harmonic"]),
    ("default", "ranked_decode", ["wide-arming", "wide-arming", "concurrent-pair", "staircase"]),
    ...
    ("default", "version_from_str", ["mirror-narrow", "concurrent-pair", "jump-pair", "staircase"]),
    ("default", "version_hash", ["-", "-", "-", "-"]),
    ("default", "causally_contains", ["hugeleaf", "dense-suffix", "dense-suffix", "ascend-plateau"]),
    ("default", "span_place", ["hugeleaf", "freeze-pos", "staircase", "staircase"]),
    ("default", "span_dominance", ["hugeleaf", "freeze-pos", "staircase", "staircase"]),
    ("default", "query_contains", ["hugeleaf", "freeze-pos", "staircase", "staircase"]),
    ("default", "query_coverage", ["hugeleaf", "freeze-pos", "staircase", "staircase"]),
    ...
    ("default", "clock_tick", ["ascend-cliff", "hugeleaf", "hugeleaf", "mirror-narrow"]),
    ("default", "clock_fork", ["id-pair", "-", "mirror-narrow,nested-full", "-"]),
    ("default", "clock_join", ["hugeleaf", "jump-pair", "id-pair", "lone-freeze"]),
    ("default", "clock_sync", ["hugeleaf", "jump-pair", "benign", "lone-freeze"]),
    ("default", "clock_recv", ["id-pair", "hugeleaf", "hugeleaf", "lone-freeze"]),
    ("default", "clock_own_version_to_version", ["id-pair", "comb-scatter", "nested-wide", "staircase"]),
    ...
    ("default", "clock_hash", ["-", "-", "-", "-"]),
    ("default", "version_decode_truncated", ["wide-arming", "freeze-pos", "ascend-cliff,ascend-plateau,benign,bigroot,cliff,comb-scatter,concurrent-pair,dense,dense-suffix,freeze-parade,freeze-pos,harmonic,hugeleaf,jump-pair,lone-freeze,mirror-narrow,mirror-wide,nested-full,nested-wide,plateau-puncture,promo-rearm,pure-comb,reveal-comb,reveal-hifloor,staircase,tooth-tail,weight-comb,wide-arming", "staircase"]),
    ("default", "version_decode_trailing", ["hugeleaf", "freeze-pos", "promo-rearm", "staircase"]),
    ("default", "version_decode_noncanon", ["hugeleaf", "freeze-pos", "freeze-parade,reveal-hifloor", "staircase"]),
    ("default", "version_parse_trailing", ["tooth-tail", "concurrent-pair", "jump-pair", "comb-scatter"]),
    ("default", "version_parse_noncanon", ["tooth-tail", "concurrent-pair", "jump-pair", "comb-scatter"]),
    ...
    ("default", "clock_decode_truncated", ["id-pair", "freeze-pos", "pure-comb", "lone-freeze"]),
    ...
    ("acceptance", "version_cmp", ["hugeleaf", "freeze-pos", "freeze-pos", "staircase"]),
    ("acceptance", "version_eq", ["-", "-", "-", "-"]),
    ("acceptance", "version_concurrent", ["hugeleaf", "freeze-pos", "freeze-pos", "staircase"]),
    ("acceptance", "version_join", ["hugeleaf", "jump-pair", "mirror-wide", "staircase"]),
    ("acceptance", "version_join_assign", ["hugeleaf", "jump-pair", "mirror-wide", "staircase"]),
    ("acceptance", "version_meet", ["hugeleaf", "jump-pair", "weight-comb", "staircase"]),
    ("acceptance", "version_meet_assign", ["hugeleaf", "jump-pair", "weight-comb", "staircase"]),
    ("acceptance", "version_span", ["jump-pair", "jump-pair", "jump-pair", "concurrent-pair"]),
    ("acceptance", "span_encode", ["promo-rearm", "-", "-", "-"]),
    ("acceptance", "span_decode", ["hugeleaf", "freeze-pos", "weight-comb", "staircase"]),
    ("acceptance", "version_tick", ["ascend-cliff", "hugeleaf", "hugeleaf", "mirror-narrow"]),
    ("acceptance", "version_ticks", ["ascend-cliff", "bigroot", "comb-scatter", "mirror-narrow"]),
    ("acceptance", "version_tick_adv_party", ["id-pair", "comb-scatter", "id-pair", "-"]),
    ("acceptance", "version_rank", ["wide-arming", "wide-arming", "dense-suffix", "harmonic"]),
    ...
    ("acceptance", "version_distance", ["wide-arming", "wide-arming", "freeze-pos", "harmonic"]),
    ("acceptance", "version_lag", ["wide-arming", "wide-arming", "freeze-pos", "harmonic"]),
    ("acceptance", "ranked_cmp", ["wide-arming", "dense-suffix", "freeze-pos", "harmonic"]),
    ("acceptance", "ranked_encode", ["wide-arming", "wide-arming", "dense-suffix", "harmonic"]),
    ("acceptance", "ranked_encode_rank", ["wide-arming", "wide-arming", "dense-suffix", "harmonic"]),
    ("acceptance", "ranked_decode", ["wide-arming", "wide-arming", "concurrent-pair", "staircase"]),
    ...
    ("acceptance", "own_version_cmp", ["hugeleaf", "freeze-pos", "freeze-pos", "lone-freeze"]),
    ...
    ("acceptance", "version_from_str", ["mirror-narrow", "concurrent-pair", "jump-pair", "staircase"]),
    ("acceptance", "version_hash", ["-", "-", "-", "-"]),
    ("acceptance", "causally_contains", ["hugeleaf", "dense-suffix", "dense-suffix", "ascend-plateau"]),
    ("acceptance", "span_place", ["hugeleaf", "freeze-pos", "freeze-pos", "staircase"]),
    ("acceptance", "span_dominance", ["hugeleaf", "freeze-pos", "freeze-pos", "staircase"]),
    ("acceptance", "query_contains", ["hugeleaf", "freeze-pos", "freeze-pos", "staircase"]),
    ("acceptance", "query_coverage", ["hugeleaf", "freeze-pos", "freeze-pos", "staircase"]),
    ...
    ("acceptance", "clock_tick", ["ascend-cliff", "hugeleaf", "hugeleaf", "mirror-narrow"]),
    ("acceptance", "clock_fork", ["id-pair", "-", "mirror-narrow,nested-full", "-"]),
    ("acceptance", "clock_join", ["hugeleaf", "jump-pair", "id-pair", "lone-freeze"]),
    ("acceptance", "clock_sync", ["hugeleaf", "jump-pair", "benign", "lone-freeze"]),
    ("acceptance", "clock_recv", ["id-pair", "hugeleaf", "hugeleaf", "lone-freeze"]),
    ("acceptance", "clock_own_version_to_version", ["id-pair", "comb-scatter", "nested-wide", "staircase"]),
    ...
    ("acceptance", "version_decode_truncated", ["wide-arming", "freeze-pos", "ascend-cliff,ascend-plateau,benign,bigroot,cliff,comb-scatter,concurrent-pair,dense,dense-suffix,freeze-parade,freeze-pos,harmonic,hugeleaf,jump-pair,lone-freeze,mirror-narrow,mirror-wide,nested-full,nested-wide,plateau-puncture,promo-rearm,pure-comb,reveal-comb,reveal-hifloor,staircase,tooth-tail,weight-comb,wide-arming", "staircase"]),
    ("acceptance", "version_decode_trailing", ["hugeleaf", "freeze-pos", "dense-suffix", "staircase"]),
    ("acceptance", "version_decode_noncanon", ["hugeleaf", "freeze-pos", "reveal-hifloor", "staircase"]),
    ("acceptance", "version_parse_trailing", ["mirror-narrow", "concurrent-pair", "jump-pair", "comb-scatter"]),
    ("acceptance", "version_parse_noncanon", ["tooth-tail", "concurrent-pair", "jump-pair", "comb-scatter"]),
    ...
    ("acceptance", "clock_decode_truncated", ["id-pair", "freeze-pos", "pure-comb", "lone-freeze"]),
    ("acceptance", "clock_decode_trailing", ["id-pair", "freeze-pos", "dense-suffix", "lone-freeze"]),
    ("acceptance", "clock_parse_trailing", ["tooth-tail", "concurrent-pair", "jump-pair", "comb-scatter"]),
