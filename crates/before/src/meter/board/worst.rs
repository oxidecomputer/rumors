...
pub(super) const WORST_RANKINGS: &[(&str, &str, [&str; 3])] = &[
    ...
    ("default", "span_union", ["dense-suffix", "dense-suffix", "stagger"]),
    ("default", "span_intersect", ["hugeleaf", "weave", "stagger"]),
    ("default", "span_join", ["dense-suffix", "stagger", "stagger"]),
    ("default", "span_meet", ["hugeleaf", "stagger", "stagger"]),
    ...
    ("default", "rank_checked_sub", ["freeze-parade", "-", "-"]),
    ("default", "rank_sum", ["plateau-puncture", "-", "freeze-pos"]),
    ("default", "rank_encode", ["hugeleaf", "-", "-"]),
    ("default", "rank_decode", ["plateau-puncture", "-", "-"]),
    ("default", "rank_display", ["freeze-parade", "-", "-"]),
    ("default", "rank_display_precision", ["-", "-", "-"]),
    ("default", "rank_parse", ["plateau-puncture", "-", "-"]),
    ("default", "ticks_clone", ["plateau-puncture", "-", "-"]),
    ...
    ("default", "span_union_all", ["stagger", "stagger", "scatter"]),
    ("default", "span_intersect_all", ["weave", "weave", "scatter"]),
    ("default", "span_join_all", ["stagger", "stagger", "scatter"]),
    ("default", "span_meet_all", ["weave", "weave", "weave"]),
    ...
    ("default", "version_shape", ["wide-arming", "freeze-pos", "-"]),
    ("default", "shape_combine_pair", ["hugeleaf", "promo-rearm", "-"]),
    ("default", "shape_combine_many", ["-", "weave", "-"]),
    ("default", "causally_contains", ["hugeleaf", "dense-suffix", "ascend-plateau"]),
    ("default", "query_single_hole", ["-", "-", "-"]),
    ...
    ("acceptance", "span_union", ["bigroot", "dense-suffix", "stagger"]),
    ("acceptance", "span_intersect", ["hugeleaf", "stagger", "stagger"]),
    ("acceptance", "span_join", ["bigroot", "stagger", "stagger"]),
    ("acceptance", "span_meet", ["hugeleaf", "stagger", "stagger"]),
    ...
    ("acceptance", "rank_checked_sub", ["freeze-parade", "-", "-"]),
    ("acceptance", "rank_sum", ["bigroot", "-", "freeze-pos"]),
    ("acceptance", "rank_encode", ["hugeleaf", "-", "-"]),
    ("acceptance", "rank_decode", ["bigroot", "-", "-"]),
    ("acceptance", "rank_display", ["freeze-parade", "-", "-"]),
    ("acceptance", "rank_display_precision", ["-", "-", "-"]),
    ("acceptance", "rank_parse", ["plateau-puncture", "-", "-"]),
    ("acceptance", "ticks_clone", ["plateau-puncture", "-", "-"]),
    ...
    ("acceptance", "version_shape", ["hugeleaf", "memo-oscillating", "-"]),
    ("acceptance", "shape_combine_pair", ["hugeleaf", "memo-oscillating", "-"]),
    ("acceptance", "shape_combine_many", ["-", "weave", "-"]),
    ("acceptance", "causally_contains", ["hugeleaf", "dense-suffix", "ascend-plateau"]),
    ("acceptance", "query_single_hole", ["-", "-", "-"]),
