...
//!   [`encode`](Ranked::encode) emits a composite byte key whose plain
//!   byte-wise order *is* the total order, [`decode`](Ranked::decode)
...
/// surface-coverage suite enforces totality over.
///
