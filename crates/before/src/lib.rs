...
//! | [`Version`]         | a causal timestamp (history of known events)    | [`tick`](Version::tick), [`PartialOrd`] (`<`, `<=`, [`concurrent`](Version::concurrent)), [`join`](Version::join) (`\|`), [`meet`](Version::meet) (`&`), [`span`](Version::span) (`^`), [`rank`](Version::rank) |
