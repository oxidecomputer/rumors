...
//! every input family's base size. The default sizes keep the whole board at
//! seconds of runtime; scale up for records. Without the `limb-meter`
//! feature the limb column reads `off`.
